...
export function isActionWithPayload<T>(
	action: Action<string> | ActionWithPayload<string, T>,
): action is ActionWithPayload<string, T> {
	return (<ActionWithPayload<string, T>>action).payload !== undefined;
}
